...
#define RP1_Pin GPIO_PIN_2
#define RP1_GPIO_Port GPIOA
#define RP2_Pin GPIO_PIN_3
#define RP2_GPIO_Port GPIOA
#define RP4_Pin GPIO_PIN_4
#define RP4_GPIO_Port GPIOA
#define RP5_Pin GPIO_PIN_5
#define RP5_GPIO_Port GPIOA
