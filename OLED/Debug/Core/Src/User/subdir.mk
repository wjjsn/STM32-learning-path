...
clean-Core-2f-Src-2f-User:
	-$(RM) ./Core/Src/User/OLED.cyclo ./Core/Src/User/OLED.d ./Core/Src/User/OLED.o ./Core/Src/User/OLED.su ./Core/Src/User/font.cyclo ./Core/Src/User/font.d ./Core/Src/User/font.o ./Core/Src/User/font.su ./Core/Src/User/menu.cyclo ./Core/Src/User/menu.d ./Core/Src/User/menu.o ./Core/Src/User/menu.su
